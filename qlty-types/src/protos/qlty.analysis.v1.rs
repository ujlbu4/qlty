...
impl Language {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "LANGUAGE_APEX" => Some(Self::Apex),
            "LANGUAGE_C" => Some(Self::C),
            "LANGUAGE_C_PLUS_PLUS" => Some(Self::CPlusPlus),
            "LANGUAGE_C_SHARP" => Some(Self::CSharp),
            "LANGUAGE_CLOJURE" => Some(Self::Clojure),
            "LANGUAGE_DART" => Some(Self::Dart),
            "LANGUAGE_ELIXIR" => Some(Self::Elixir),
            "LANGUAGE_GO" => Some(Self::Go),
            "LANGUAGE_GROOVY" => Some(Self::Groovy),
            ...
            "LANGUAGE_OBJECTIVE_C" => Some(Self::ObjectiveC),
            "LANGUAGE_PERL" => Some(Self::Perl),
            "LANGUAGE_PHP" => Some(Self::Php),
            "LANGUAGE_POWERSHELL" => Some(Self::Powershell),
            "LANGUAGE_PYTHON" => Some(Self::Python),
            "LANGUAGE_R" => Some(Self::R),
            "LANGUAGE_RUBY" => Some(Self::Ruby),
            "LANGUAGE_RUST" => Some(Self::Rust),
            "LANGUAGE_SCALA" => Some(Self::Scala),
            "LANGUAGE_SH" => Some(Self::Sh),
            "LANGUAGE_SQL" => Some(Self::Sql),
            "LANGUAGE_SWIFT" => Some(Self::Swift),
            "LANGUAGE_TSX" => Some(Self::Tsx),
            "LANGUAGE_TYPESCRIPT" => Some(Self::Typescript),
            "LANGUAGE_VB" => Some(Self::Vb),
            "LANGUAGE_VBDOTNET" => Some(Self::Vbdotnet),
            _ => None,
        }
    }
}
