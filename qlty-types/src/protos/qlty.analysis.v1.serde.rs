...
impl serde::Serialize for Language {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::Apex => "LANGUAGE_APEX",
            Self::C => "LANGUAGE_C",
            Self::CPlusPlus => "LANGUAGE_C_PLUS_PLUS",
            Self::CSharp => "LANGUAGE_C_SHARP",
            Self::Clojure => "LANGUAGE_CLOJURE",
            Self::Dart => "LANGUAGE_DART",
            Self::Elixir => "LANGUAGE_ELIXIR",
            Self::Go => "LANGUAGE_GO",
            Self::Groovy => "LANGUAGE_GROOVY",
            Self::Java => "LANGUAGE_JAVA",
            Self::Javascript => "LANGUAGE_JAVASCRIPT",
            Self::Jsx => "LANGUAGE_JSX",
            Self::Kotlin => "LANGUAGE_KOTLIN",
            Self::ObjectiveC => "LANGUAGE_OBJECTIVE_C",
            Self::Perl => "LANGUAGE_PERL",
            Self::Php => "LANGUAGE_PHP",
            Self::Powershell => "LANGUAGE_POWERSHELL",
            Self::Python => "LANGUAGE_PYTHON",
            Self::R => "LANGUAGE_R",
            Self::Ruby => "LANGUAGE_RUBY",
            Self::Rust => "LANGUAGE_RUST",
            Self::Scala => "LANGUAGE_SCALA",
            Self::Sh => "LANGUAGE_SH",
            Self::Sql => "LANGUAGE_SQL",
            Self::Swift => "LANGUAGE_SWIFT",
            Self::Tsx => "LANGUAGE_TSX",
            Self::Typescript => "LANGUAGE_TYPESCRIPT",
            Self::Vb => "LANGUAGE_VB",
            Self::Vbdotnet => "LANGUAGE_VBDOTNET",
        };
        serializer.serialize_str(variant)
    }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "LANGUAGE_APEX" => Ok(Language::Apex),
                    "LANGUAGE_C" => Ok(Language::C),
                    "LANGUAGE_C_PLUS_PLUS" => Ok(Language::CPlusPlus),
                    "LANGUAGE_C_SHARP" => Ok(Language::CSharp),
                    "LANGUAGE_CLOJURE" => Ok(Language::Clojure),
                    "LANGUAGE_DART" => Ok(Language::Dart),
                    "LANGUAGE_ELIXIR" => Ok(Language::Elixir),
                    "LANGUAGE_GO" => Ok(Language::Go),
                    "LANGUAGE_GROOVY" => Ok(Language::Groovy),
                    ...
                    "LANGUAGE_OBJECTIVE_C" => Ok(Language::ObjectiveC),
                    "LANGUAGE_PERL" => Ok(Language::Perl),
                    "LANGUAGE_PHP" => Ok(Language::Php),
                    "LANGUAGE_POWERSHELL" => Ok(Language::Powershell),
                    "LANGUAGE_PYTHON" => Ok(Language::Python),
                    "LANGUAGE_R" => Ok(Language::R),
                    "LANGUAGE_RUBY" => Ok(Language::Ruby),
                    "LANGUAGE_RUST" => Ok(Language::Rust),
                    "LANGUAGE_SCALA" => Ok(Language::Scala),
                    "LANGUAGE_SH" => Ok(Language::Sh),
                    "LANGUAGE_SQL" => Ok(Language::Sql),
                    "LANGUAGE_SWIFT" => Ok(Language::Swift),
                    "LANGUAGE_TSX" => Ok(Language::Tsx),
                    "LANGUAGE_TYPESCRIPT" => Ok(Language::Typescript),
                    "LANGUAGE_VB" => Ok(Language::Vb),
                    "LANGUAGE_VBDOTNET" => Ok(Language::Vbdotnet),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
